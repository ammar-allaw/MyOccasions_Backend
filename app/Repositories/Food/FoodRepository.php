...
class FoodRepository implements FoodRepositoryInterface
{
    ...
    {
        $query = Food::with(['mainKey', 'serviceProvider', 'orderStatusAble.status', 'media']);
    ...
    {
        return Food::with(['mainKey', 'serviceProvider', 'orderStatusAble.status', 'media'])->findOrFail($id);
    }
